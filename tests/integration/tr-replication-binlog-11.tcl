start_server {tags {"repl"}} {
    start_server {tags {"repl"} tredis1210} {
        ...
        if {$::accurate} {set numops 2000000} else {set numops 1200000}

        test {MASTER(v1.2.10) and SLAVE(v1.3.0) consistency resume follow up} {
            createComplexDataset r $numops {tredis useexpire}
            wait_sync 7200000 3600000 200000 200000
