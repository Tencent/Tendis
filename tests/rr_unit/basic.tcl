start_server {tags {"basic"}} {
    test {DEL all keys to start with a clean DB} {
        ...
        # we need to do a reload after a flushall
        # before we run dbsize
        r dbsize
    } {0}
	...
	test {INCR over an expired float} {
		r set novar 0.1111
		r pexpire novar 1
		after 2
		r incrbyfloat novar	5.5
	} {5.5}
	...
	test "SETBIT against expired key" {
		r set mystring 1
		r expire mystring 3
		after 6
		r setbit mystring 7 1
		r setbit mystring 6 1
